    ...
    return SafeArea(
      child: StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          // Delete expired appointments in the background
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text('اسم المريض: ${document['name']}',style: getBodyStyle(context,color: AppColors.darkColor),),
                              ...
                              Row(
                                children: [
                                  const Icon(Icons.location_on_rounded,
                                      color: AppColors.primaryColor, size: 16),
                                  const SizedBox(width: 10),
                                  Text(document['location'],style: getBodyStyle(context,color: AppColors.darkColor),),
                                ],
                              ),
                              const SizedBox(height: 10),
                              SizedBox(
