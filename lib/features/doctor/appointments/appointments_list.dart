...
class MyAppointmentListDoctor extends StatefulWidget {
  const MyAppointmentListDoctor({super.key});

  @override
  _MyAppointmentListDoctorState createState() => _MyAppointmentListDoctorState();
}

class _MyAppointmentListDoctorState extends State<MyAppointmentListDoctor> {
          ...
          return snapshot.data!.docs.isEmpty
            ...
            child: Column(
              ...
              children: [
                ...
                Text('لا يوجد حجوزات قادمة', style: getBodyStyle(context,)),
              ],
            ),
          )
              : ListView.builder(
